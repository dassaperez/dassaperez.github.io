const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=2172797&units=imperial&appid=870f9f8e374ae60332de7b743d11497d";
fetch(apiURL)
...
const dayForecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=2172797&appid=870f9f8e374ae60332de7b743d11497d&units=imperial";
fetch(dayForecastURL)
  ...
  .then((jsObject) => {
    ...
    const sixoclock = myList.filter(x => x.dt_txt.includes("12:00:00"));
    /* I want to
       create a smaller list with only objects that are at 12:00, 12:00:00*/
