const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=870f9f8e374ae60332de7b743d11497d";
fetch(apiURL)
...
const dayForecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=870f9f8e374ae60332de7b743d11497d&units=imperial";
...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
            ...
            const townName = towns.filter(x => x.name.includes("Fish Haven"));
